...
{
    public class PickingExtraction
    {
        public PickingExtraction(string path)
        {
            _path = path;
            ...
            while (!reader.EndOfStream)
            {
                ...
                try
                {
                    if (lineElements != null)
                    {
                        ...
                        var article = new Classes.Simulation.Orders.Article(articleNumber, materialName, areaCode);
