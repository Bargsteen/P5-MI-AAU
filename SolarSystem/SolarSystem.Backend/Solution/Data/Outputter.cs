...
namespace SolarSystem.Backend.Solution.Data
{
    public class Outputter
    {
        ...
        private static readonly StreamWriter File = new StreamWriter(Directory.GetParent(Directory.GetParent(Directory.GetParent(Environment.CurrentDirectory).ToString())
